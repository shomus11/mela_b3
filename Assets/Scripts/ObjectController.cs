...
public class ObjectController : MonoBehaviour
{
    ...
    public void RotateObject(bool set)
    {
        ...
        if (set)
        {
            ...
            display.Insert(0, gameObject.transform.DOLocalMoveZ(startPos.z - 5, baseAnimationDuration * 24).From(startPos.z + 14f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.Linear));
